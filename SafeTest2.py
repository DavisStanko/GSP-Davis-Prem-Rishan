...
def lang_options():
    global ttk
    ttk = GoogleTranslator(entry.get(1.0, 'end'), choose_langauge.index(option_variable.get()))
    ttk.translate()
...
entry = Text(root, width=35, height=20, borderwidth=3, relief=RIDGE, wrap='word')
...
result = Label(root, width=35, height=20, anchor=NW, borderwidth=3, relief=RIDGE, wraplength=300, justify=LEFT)
